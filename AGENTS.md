...
Rules for any AI coding agent working in this repository. Read this file first.

These are the [AI Crew Rules](https://github.com/kxc7558/ai-crew-rules) — discipline for AI coding crews. Tool-specific adapters: Claude Code uses the plugin or the skill at `skills/ai-crew/`; Cursor reads `.cursor/rules/ai-crew.mdc`.
...
Copy the layered scaffold from `skills/ai-crew/templates/layered-project/`, then `git init` and commit the scaffold as the first node before implementing anything.
